    ...
    public function store(Request $request)
{
    ...
    // Crear una nueva instancia del modelo Project_management
    $projects_management = new Project_management();

    // Asignar valores de entrada a las propiedades del modelo
    ...
    // Incrementar el valor de 'likes' en 1
    $request->merge(['likes' => $request->input('likes') + 1]);

    // Asignar el valor incrementado de 'likes' al modelo
