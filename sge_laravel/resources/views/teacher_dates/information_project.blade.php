                            ...
                            <div class="table-wrapper">
                                <table class="project-table">
                                    ...
                                    <tr>
                                        ...
                                        <div>
                                            <h2 class="text-left font-medium text-lg ml-24 mr-10 py-2">3. Justificación:</h2>
                                            <div class="section">
                                        ...
                                        <div>
                                            ...
                                            <div class="section">
                                                ...
                                                <h3 class="text-center font-medium text-xl ml-24 mr-10 py-2">Para ser llenado por la Comision de Estadia</h3>
                                                <br />
                                                <br />
                                                <div class="flex">
