...
<div class=" min-h-screen px-12 py-12 justify-start items-center "  >
   ...
   <div class="flex flex-row justify-between"> 
    <div class="flex items-center w-80 h-11 border-2 bg-gray-200 border-[#01A080] rounded-md">
        <input type="text" class="w-full outline-none border-none rounded-md bg-slate-200 " placeholder="Buscar rol">
        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
    </div>
