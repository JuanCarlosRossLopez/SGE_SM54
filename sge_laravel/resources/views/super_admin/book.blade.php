        ...
        <div class="bg-[#01A080] w-max rounded shadow-lg max-w-4xl">
            ...
            <div class="bg-white p-10">
                ...
                <div class="modal-body max-h-full h-auto">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    ...
                                    id="grid-city" type="text" placeholder="Carlos">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                    for="grid-city">
                    ...
                    <button class="bg-[#05af9b] pl-[0.5rem] pr-[0.5rem]  border-[#05af9b] item-center rounded-lg w-full  text-white px-2  py-1">Añadir libro</button>
                </div>
            </div>
        </div>
    </div>
