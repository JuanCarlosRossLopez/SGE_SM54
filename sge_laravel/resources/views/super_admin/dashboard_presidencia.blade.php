...
@section('contenido')
    <div class="back_conteine">
        ...
        <div class=" conteiner_cards">
            <div class="conteiner_cards flex flex-row w-fit">

                <!--acciones varias-->
                <div class="content_conteiner w-fit h-fit">
                    <label class="conteiner_word_title flex flex-col items-center">Acciones varias</label>
                    <div class="conteiner_cards flex flex-row">
                        <!-- Panel 1 -->
                        <div class="bg-white p-3 rounded flex flex-row">
                            <div class="w-[15rem] text-center flex flex-row items-center ">
                                ...
                                <div class="relative dropdown-trigger">
                                    ...
                                    <div class="hidden absolute bg-white border border-gray-200 mt-2 py-2 rounded w-48 z-10 dropdown-content">
                                        <a href="{{ route('maestros.index', ['division' => Auth::user()->division_id]) }}" class="block px-4 py-2 text-gray-800 text-xs hover:bg-gray-200">
                                ...
                                <div
                                    class="items-center justify-start font-bold text-gray-400 text-[13px] gap-2">
                            ...
                            <div class="bg-white p-3 rounded">
                                <div class="w-[15rem] text-center flex flex-row items-center">
                                    <label class="font-semibold font-poppins text-lg text-start w-full">Cedulas de
                                        anteproyecto</label>
                                    <div class="relative dropdown-trigger">
                                        <button class="dropdown-btn w-[2rem] h-[2rem] hover:bg-slate-300 rounded-full">
                                            <i class="fa-solid fa-ellipsis-vertical"></i>
                                        ...
                                        <div
                                            ...
                                            <a href="/gestion_asesor_anteproyecto"
                                                class="block px-4 py-2 text-gray-800 text-xs hover:bg-gray-200">División de
                                                Turismo</a>
                                            <a href="/gestion_asesor_anteproyecto"
                                                class="block px-4 py-2 text-gray-800 text-xs hover:bg-gray-200">División de
                                                Ingeniería y Tecnología</a>
                                            <a href="/gestion_asesor_anteproyecto"
                                                class="block px-4 py-2 text-gray-800 text-xs hover:bg-gray-200">División
                                                Económico-Administrativo</a>
                                            <a href="/gestion_asesor_anteproyecto"
                                                class="block px-4 py-2 text-gray-800 text-xs hover:bg-gray-200">División de
                                                Gastronomía</a>
                                        </div>
                            ...
                            <div class="bg-white p-3 rounded">
                                <div class="w-[15rem] text-center flex flex-row items-center">
                                    <label class="font-semibold font-poppins text-lg text-start w-full">Gestiónar estudiantes
                                    </label>
                                    <div class="relative dropdown-trigger">
                                        <button class="dropdown-btn w-[2rem] h-[2rem] hover:bg-slate-300 rounded-full">
                                            <i class="fa-solid fa-ellipsis-vertical"></i>
                                        ...
                                        <div class="hidden dropdown-content">
                                            <a href="/usuarios" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Ver
                                                estudiantes</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="conteiner_cards w-full">
                            ...
                            <div class="flex flex-col gap-[15rem]">
                                <div class="bg-white w-fit h-fit p-3 rounded">
                                    <div class="w-[15rem] text-center flex flex-row items-center">
                                        <label class="font-semibold font-poppins text-base text-start w-full">Información
                                            relevante</label>
                                        <div class="relative dropdown-trigger">
                                            <button class="dropdown-btn w-[2rem] h-[2rem] hover:bg-slate-300 rounded-full">
                                                <i class="fa-solid fa-ellipsis-vertical"></i>
                                    ...
                                    <div>
                                        <label
                                            class="font-normal font-poppins text-sm text-start w-full">Descripciones</label>
                                    </div>
                                </div>
                                <div class="bg-white w-fit h-fit p-3 rounded">
                                    <div class="w-[15rem] text-center flex flex-row items-center">
                ...
                <div class="content_conteiner h-fit p-1 w-fit ml-[-2.5rem]">
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="bg-white p-3 rounded">
                            ...
                            <div>
                                <label class="font-normal font-poppins text-sm text-start w-full">Visualizacion de
                                    historial</label>
                            </div>
                        </div>
                    </div>
