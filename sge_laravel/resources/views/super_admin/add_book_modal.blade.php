    ...
    <div class="bg-[#01A080] w-max rounded shadow-lg max-w-4xl">
        ...
        <div class="bg-white p-10">
            ...
            <div class=" max-h-full h-auto">
                <form action={{ route('gestion_libros.store') }} method="POST" enctype="multipart/form-data" class="w-full max-w-lg">
                    @csrf
                    <div class="flex aflex-col flex-wrap -mx-3 mb-6 w-full">
