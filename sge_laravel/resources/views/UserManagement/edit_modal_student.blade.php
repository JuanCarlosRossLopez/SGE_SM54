                ...
                <div class="modal-body flex-col gap-4 mb-0 overflow-y-auto flex items-center justify-center p-10">
                    <div class="flex flex-col items-center justify-center">
                        <div class="flex items-center justify-between w-full mb-4">
                            <h1 class="text-xl font-bold">Editando al estudiantes</h1>
                        ...
                        <form action="{{ route('estudiantes.update', $user->id) }}" method="POST" class="flex flex-col gap-4 mt-10">
                            ...
                            <div class="flex gap-4 items-center mt-3 w-full">
                                ...
                                <select name="career_id" class="flex-1 rounded-md border border-gray-300 p-2">
                            ...
                            <div class="flex gap-4 items-center mt-3 w-full">
                                ...
                                <select name="group_id" class="flex-1 rounded-md border border-gray-300 p-2">
                                    <option selected>{{$user->student->group ? $user->student->group->group_name : 'Sin grupo'}}</option>
