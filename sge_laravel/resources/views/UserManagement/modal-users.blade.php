...
<div id="show{{ $user->id }}"
    ...
    <div class="bg-[#01A080] w-full rounded shadow-lg max-w-2xl">
        <div class="border-b px-4 py-2 flex justify-between items-center">
            <h3 class="font-semibold text-lg ml-60 text-white">Datos del usuarios:
                {{ $user->name }}</h3>
            <button class="close-modal-view bg-white rounded-full h-[1rem] flex items-center">
        ...
        <div class="bg-white p-2">
            <div class="modal-body ">
                <div class="py-6 flex flex-col px-2 text-center gap-4">
                    ...
                    <div class="flex flex-row gap-2">
                        <h1 class=" font-sans font-semibold text-[#545454]">Contraseña:</h1>
                        <h5> {{ $user->password }} </h5>
                    </div>
                </div>
            </div>
