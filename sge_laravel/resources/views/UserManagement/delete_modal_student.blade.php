<div id="delete{{ $user->id }}"
    class="modal-delete-student h-screen w-full fixed left-0 top-0 hidden flex justify-center items-center bg-black bg-opacity-50">
    ...
    <div class="bg-[#01A080] w-full rounded shadow-lg max-w-2xl">
        ...
        <div class="bg-white p-2">
            <div class="modal-body flex-col gap-4 mb-0 overflow-y-auto flex items-center justify-center P-10 ">
                ...
                <form action="{{ url('estudiantes',$user->id ) }}" method="POST">
                    @method('DELETE')
                    @csrf
