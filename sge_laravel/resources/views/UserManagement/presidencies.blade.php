                ...
                <table class="standar_table">
                    ...
                    <tbody class="tbody">
                        ...
                        <tr class="trow">
                            ...
                            <td class="trowc">
                                <button class="show-modal-view" data-target="#show{{ $presidencies->id }}">
                                    <div class="comment-icon flex items-center justify-center">
                                        <i class="bi bi-eye-fill"></i>
                                    </div>
                                </button>
                                <button class="show-modal4" data-target="#edit{{ $presidencies->id }}">
                                    <div class="comment-icon flex items-center justify-center">
                                        <i class="bi bi-pencil-square" style="color: blue;"></i>
                                    </div>
                                </button>

                                <button class="show-modal" data-target="#delete{{$presidencies->id}}">
                                    <div class="comment-icon flex items-center justify-center">
                        ...
                        @include('UserManagement.modal-presidents')
                ...
                <div class="bg-[#01A080] w-full rounded shadow-lg max-w-sm">
                    ...
                    <div class="modal-container">
                        ...
                        <div class="bg-white rounded shadow-xl  px-20 py-14 items-center justify-center">
                            <form action="{{ route('presidencies.store') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Nombre
                                        de
                                        usuario</label>
                                    <input type="text" name="name_presidencies" class="rounded input-field">
                                </div>

                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2">Email</label>
                                    <input type="float" name="playroll_presidencies" class="rounded input-field">
                                </div>
