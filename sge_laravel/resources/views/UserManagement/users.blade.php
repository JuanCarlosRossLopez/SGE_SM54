                ...
                <div class="w-full ">
                    <div class="">
                        ...
                        <div class="flex flex-row items-center justify-start gap-2 ">
                            ...
                            <form action="{{ route('users.filterByRole') }}" method="GET" class="bg-[#F1F0F0] border-2 rounded m-2 justify-center flex flex-row items-center gap-2">
                                <div class="flex flex-row w-fit  justify-start p-1 items-center">
                                    <div class="flex items-center gap-2">
                                        <label for="role" class="w-full text-start font-sans font-semibold text-[#545454] text-lg">Filtrar
                                            por rol</label>
                                        <select name="role" id="role" class=" text-base text-[#000000] border-1 border-[#0000002b] focus:ring-[#0000004e] focus:border-[#0000004e] rounded bg-white">
                    ...
                    <div idModal="teacherAdd" class="modal h-screen w-full fixed left-0 top-0 hidden flex justify-center items-center bg-black bg-opacity-50">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr class="trow">
                                ...
                                <td class="trowc">
                                    ...
                                    <!-- Validar si el usuario es el mismo que el usuario autenticado -->
                                    @elseif($user->student)
                                    <button class="show-modal-student-view" data-modal="#view{{ $user->id }}">
                                        <div class="button_see_blue">
                                            <i class="fa-solid fa-eye"></i>
                                        </div>
                                        ...
                                        @else
                                        <button class="show-modal-delete-student" data-modal="#delete{{ $user->id }}">
                                            <div class="button_delete_red">
                                                <i class="fa-solid fa-trash"></i>
                                            </div>
                                        </button>
                                        ...
                                        <button class="show-modal" data-modal="view_presidencies{{ $user->id }}">
                                            <div class="button_see_blue">
                                                <i class="fa-solid fa-eye"></i>
                                            </div>
                                        </button>

                                        <button class="show-modal" data-modal="edit_president{{ $user->id }}">
                                            <div class="button_edit_yellow">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </div>
                                        </button>
                                        ...
                                        @else
                                        <button class="show-modal" data-modal="delete_president{{ $user->id }}">
                                            <div class="button_delete_red">
                                                <i class="fa-solid fa-trash"></i>
                                            </div>
                                        </button>
                                        ...
                                        <button class="show-modal-edit-coordination" data-target="#edit{{ $user->id }}">
                                            <div class="button_edit_yellow">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </div>
                                        </button>
                                        ...
                                        @else
                                        <button class="show-modal-delete-coordination" data-modal="#delete{{ $user->id }}">
                                            <div class="button_delete_red">
                                                <i class="fa-solid fa-trash"></i>
                                            </div>
                                        </button>
                                        @endif
                                        <button class="show-modal-coordination-view" data-modal="#view{{ $user->id }}">
                                            <div class="button_see_blue">
                                                <i class="fa-solid fa-eye"></i>
                                            </div>
                                        </button>
