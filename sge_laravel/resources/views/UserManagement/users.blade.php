                ...
                <div class="w-full ">
                    <div class="">
                        ...
                        <div class="flex flex-row items-center justify-start gap-2 ">
                            ...
                            <div class="w-fit p-1 border-2 bg-[#F1F0F0] text-center flex flex-row items-center rounded gap-2">
                                ...
                                <div class="relative dropdown-trigger gap-2">
                                    ...
                                    <div class="hidden absolute bg-white border border-gray-200 mt-2  py-2 rounded w-48 z-10 dropdown-content">
                                        ...
                                        <a class="show_modal_president block font-sans w-full text-center cursor-pointer p-2 hover:bg-gray-200 font-normal text-[#545454] text-base">Presidente
                                            (Sin acción)</a>
                                        <a href="#" class="block font-sans w-full text-center cursor-pointer p-2 hover:bg-gray-200 font-normal text-[#545454] text-base">Cordinador
                                            (Sin acción)</a>
                            ...
                            <div class="modal-add-president h-screen w-full fixed left-0 top-0 hidden flex justify-center items-center bg-black bg-opacity-50 ">
...
{{                                            $user->presidencies->president_lastname
                                        ...
                                        <td class="trowc">
                                            <button class="show-modal-view px-1" data-target="#show{{ $user->id }}">
