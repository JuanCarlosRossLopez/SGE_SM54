...
<div
        id="route{{ 'division.edit', $divisions->id }}" class="modal-edit-division h-screen w-full fixed left-0 top-0 flex justify-center hidden items-center bg-black bg-opacity-50">
                    ...
                    <form action="{{ route('division.update', $divisions->id)}}" method="POST">
                        ...
                        <div class="flex flex-col items-center">
                            <div class="flex flex-col items-center w-full pb-2">
                                ...
                                <input type="text" name="division_name" value="{{$divisions->division_name}}" id="division_name" class="w-[20rem]">
                                @error('division_name')
