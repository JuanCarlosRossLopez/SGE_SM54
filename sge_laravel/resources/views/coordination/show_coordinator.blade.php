        ...
        <div
            ...
            <div class="bg-green-500 w-[600px] rounded shadow-lg max-w-4xl ">
                <div class="border-b px-4 py-2 flex justify-between items-center">
                    <h3 class="font-semibold text-lg justify-center items-center text-white text-center">Datos
                        Coordinador</h3>
                ...
                <div class="bg-white p-2">
                    <div class="modal-body mb-0 overflow-y-auto h-[100vh]">
                        <div class="container mx-auto px-4 py-8">
                            <h1 class="text-center font-semibold text-2xl">Datos del Coordinador</h1>
