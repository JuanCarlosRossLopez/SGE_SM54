...
@section('contenido')
    <div class="back_conteiner">
        ...
        <div class=" conteiner_cards">
            <div class="conteiner_cards1 flex flex-col w-[50rem]">
                <div class="content_conteiner w-fit h-fit">
                    ...
                    <div class="conteiner_cards2 ">
                        ...
                        {{-- <div class="bg-white p-3 rounded">
                            <div class="w-[15rem] text-center flex flex-row items-center">
                                <label class="font-semibold font-poppins text-lg text-start w-full">Generar reporte</label>
                                <button class="w-[2rem] h-[2rem] hover:bg-slate-300 rounded-full ">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        class="w-5 h-5">
                                        <path fill-rule="evenodd"
                                            d="M8.22 5.22a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06-1.06L11.94 10 8.22 6.28a.75.75 0 0 1 0-1.06Z"
            ...
            <div class="content_conteiner h-fit p-1 w-fit ml-[3.5rem]">
