        ...
        <div class="back_conteiner">
            ...
            <script>
                ...
                divisionSelectMasivo.addEventListener('change', function() {
                    ...
                    const numberOfCarreras = 5; // Cambia este número según cuántas grupos desees agregar
                    for (let i = 0; i < numberOfCarreras; i++) {
                        carrerasContainer.innerHTML += `
                            <div class="flex gap-4">
                                <input type="text" name="group_names[]" placeholder="Nombre del grupo ${i + 1}" class="flex-1 rounded-md border border-gray-300 p-2">
                            </div>
                        `;
                    }
                });
