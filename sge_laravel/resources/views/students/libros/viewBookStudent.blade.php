<div id="view{{ $book->id }}"
    class="modalView h-screen w-full fixed left-0 top-0 hidden flex justify-center items-center bg-black bg-opacity-50 z-10">
        ...
        <div class="bg-white p-10">
            ...
            <div class="modal-body max-h-full h-auto flex gap-7">
                <div class="w-full md:w-auto">
                    <img src="{{ asset('books/' . $book->book_front_page) }}" alt=""
                        class=" w-fit md:w-[22rem] h-fit">
                </div>
                <div class=" w-[32rem]  mb-0   items-center justify-center">
                    ...
                    <label for="font-semibold text-[15px]">Estado</label>
                    @if ($book->status == 0)
                        <p class="poppins-light text-[15px]">
                            Aceptado
                        </p>
