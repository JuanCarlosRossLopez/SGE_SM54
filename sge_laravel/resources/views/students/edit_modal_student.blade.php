    ...
    <form method="POST" action="{{ url('estudiantes', $user->id) }}">
        ...
        <div class="bg-[#01A080] w-full rounded shadow-lg max-w-2xl">
            <div class="border-b px-4 py-2 flex justify-between items-center">
                <!-- Título del modal -->
                <h3 class="font-semibold text-lg ml-60 text-white">Editar al opo</h3>
                ...
                <div class="modal-body flex-col gap-4 mb-0 overflow-y-auto flex items-center justify-center p-10">
                    <div class="flex flex-col items-center justify-center">
                        <div class="flex items-center justify-between w-full mb-4">
                            <!-- Título del campo Carrera -->
                            <label for="career_id">Carrera:</label>
                            <!-- Título "Editando al estudiante" -->
                            <h1 class="text-xl font-bold">Editando al estudianted</h1>
                        ...
                        <form action="{{ route('estudiantes.update', $user->id) }}" method="POST" class="flex flex-col gap-4">
                            ...
                            <div class="flex justify-center">
                                <!-- Título "Guardar" -->
                                <label for="career_id">Guardar:</label>
