        ...
        <div class=" conteiner_cards">
            <div class="conteiner_cards1 flex flex-col w-fit">
                <div class="content_conteiner w-full h-fit">
                    ...
                    <div class="conteiner_cards2 w-fit mt-3">
                        <!-- Panel 2 -->
                        <div class="bg-white p-3 rounded">
                            <div class="w-[15rem] text-center flex flex-row items-center">
                                <label class="font-semibold font-poppins text-lg text-start w-full">Anteproyectos</label>
                                <div class="relative dropdown-trigger">
                                    <button class="dropdown-btn w-[2rem] h-[2rem] hover:bg-slate-300 rounded-full">
                                        <i class="fa-solid fa-ellipsis-vertical"></i>
                                    </button>
                                    <div
                                        class="hidden dropdown-content">
                        ...
                        <div class="bg-white p-3 rounded">
                            <div class="w-[15rem] text-center flex flex-row items-center">
                                ...
                                <div class="relative dropdown-trigger">
                                    ...
                                    <div
                                        class="hidden absolute dropdown-content">
                                        <a href=""
                                            class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Ver mis asesorados</a>
                                    </div>
                                </div>
                            </div>
                            <div>
                ...
                <div class="content_conteiner h-fit p-1 w-fit md:ml-[-2.5rem] sm:ml-0">
                    <div class="flex flex-col gap-1">
                            ...
                            <div class="w-[16rem] text-center flex flex-row items-center">
                                ...
                                <div class="relative dropdown-trigger">
                                    ...
                                    <div
                                        class="hidden absolute dropdown-content">
                                        <a href="#"
                                            class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Ver libros</a>
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="bg-white p-3 rounded">
                            ...
                            <div>
                                <label class="font-normal font-poppins text-sm text-start w-full">Consultar memorias</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="content_conteiner h-fit p-0 w-[18.7rem] md:ml-[-2.5rem] sm:ml-0">
